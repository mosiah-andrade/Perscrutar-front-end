...
import { UsersRound, Home, IdCardLanyard, LogOut } from "lucide-react";
...
export default function Moldura({
  ...
  const menuItems = [
    ...
    },
    {
      ...
      href: "/dashboard/cadastroUsuario",
      icon: IdCardLanyard,
    },
  ];
  ...
  return (
    <div className="flex min-h-screen">
      {/* Adicionado justify-between para empurrar o botão de sair para baixo */}
